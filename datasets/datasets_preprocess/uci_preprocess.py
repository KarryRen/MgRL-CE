...
UCI_DOWNLOAD_FILE_PATH = ("/Users/karry/KarryRen/Scientific-Projects/"
...
with open(UCI_DOWNLOAD_FILE_PATH, "r") as f:  # read the raw data
...
with open(UCI_DOWNLOAD_FIX_FILE_PATH, "w") as f:  # write the right line to file
...
uci_data = pd.read_table(UCI_DOWNLOAD_FIX_FILE_PATH, delimiter=";")  # read data
